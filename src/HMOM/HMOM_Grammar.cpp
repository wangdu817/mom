...
namespace MOM
{
	void HMOM_Grammar::DefineRules()
	{
		...
		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@SurfaceDensityCorrectionCoefficientA2",
			OpenSMOKEpp::SINGLE_DOUBLE,
		...
		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@SurfaceDensityCorrectionCoefficientB2",
			OpenSMOKEpp::SINGLE_DOUBLE,
		...
		// ----------------------------------------------------------------------------------------------------------- //
		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@Efficiency6",
			OpenSMOKEpp::SINGLE_DOUBLE,
