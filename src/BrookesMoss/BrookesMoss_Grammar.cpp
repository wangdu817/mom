...
namespace MOM
{
	void BrookesMoss_Grammar::DefineRules()
	{
		...
		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@Precursors",
			OpenSMOKEpp::SINGLE_STRING,
			"Species to be assumed as soot precursors (example: @Precursors C2H2;)",
			true));

		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@SurfaceGrowthSpecies",
			OpenSMOKEpp::SINGLE_STRING,
			"Species to be assumed as partecipating surface growth species (example: @SurfaceGrowthSpecies C2H2;)",
			true));				

		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@SootParticleDiameter",
		...
		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@Talpha",
			OpenSMOKEpp::SINGLE_MEASURE,
		...
		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@Cgamma",
			OpenSMOKEpp::SINGLE_MEASURE,
			"Surface growth rate scaling factor (default: 11700 kgm/kmol/s)",
			false));

		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@Tgamma",
			OpenSMOKEpp::SINGLE_MEASURE,
			"Activation temperature of surface growth (default: 12100 K)",
			false));

		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@Comega",
			OpenSMOKEpp::SINGLE_MEASURE,
		...
		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@SurfaceGrowthExponent1",
			OpenSMOKEpp::SINGLE_DOUBLE,
			"Exponent of concentration in surface growth (default: 1)",
			false));	
			
		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@SurfaceGrowthExponent2",
			OpenSMOKEpp::SINGLE_DOUBLE,
		...
		AddKeyWord(OpenSMOKEpp::DictionaryKeyWord("@NsNorm",
			OpenSMOKEpp::SINGLE_MEASURE,
